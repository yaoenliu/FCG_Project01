...
private:
	...
	Mesh processMesh(aiMesh* mesh, const aiScene* scene, aiMatrix4x4 mTransformation);
...
Mesh Model::processMesh(aiMesh* mesh, const aiScene* scene, aiMatrix4x4 mTransformation)
{
	// data to fill
	vector<Vertex> vertices;
	vector<unsigned int> indices;
